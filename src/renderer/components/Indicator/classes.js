...
export default theme => {
    const animationLine1 = helper.randomName();
    const animationLine2 = helper.randomName();
    const animationLine3 = helper.randomName();
    const animationLine4 = helper.randomName();
